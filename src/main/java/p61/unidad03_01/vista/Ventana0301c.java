...
public class Ventana0301c extends JFrame {
    ...
    public void iniciarPaneles() {
        ...
        this.jPanelList.get(5).setLayout(new BorderLayout());
        ...
        this.jPanelList.get(17).setBackground(Color.BLACK);
        this.jPanelList.get(18).setBackground(Color.BLACK);
        this.jPanelList.get(19).setBackground(Color.BLACK);
        this.jPanelList.get(20).setBackground(Color.BLACK);
        this.jPanelList.get(21).setBackground(Color.BLACK);
        this.jPanelList.get(22).setBackground(Color.BLACK);
        ...
        this.jPanelList.get(5).add(this.jPanelList.get(17), BorderLayout.WEST);
        this.jPanelList.get(5).add(this.jPanelList.get(18), BorderLayout.NORTH);
        this.jPanelList.get(5).add(this.jPanelList.get(20), BorderLayout.EAST);
        this.jPanelList.get(6).add(this.jPanelList.get(21), BorderLayout.WEST);
        this.jPanelList.get(6).add(this.jPanelList.get(22), BorderLayout.EAST);
